...
**Apache OpenNLP**와 **TF-IDF** 알고리즘을 사용해 문서의 핵심 명사를 식별하고, 빈도를 기반으로 중요한 키워드를 분석합니다.
...
이 프로젝트는 대학에서 수강한 **"디지털 인문학을 위한 데이터 처리와 분석"** 강의에서 영감을 받아 시작하게 되었습니다.

해당 강의에서 자연어 처리와 단어 빈도 분석 기법을 배우며 **TF-IDF** 알고리즘이 문서에서 중요한 키워드를 분석하는 데 적합하다고 생각했습니다.

또한 **Hacker News**의 다양한 게시글을 보며, 시간에 따라 개발자들이 어떤 키워드에 관심을 가지는지 궁금해졌고, 이를 분석하는 기능을 구현하기 위해 이 프로젝트를 기획하게 되었습니다.
